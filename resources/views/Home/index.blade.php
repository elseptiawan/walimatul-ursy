...
<head>
    ...
    <title>Undangan Pernikahan Hasna dan Elshandi</title>
    ...
    <meta name="title" content="Website Undangan Pernikahan Hasna dan Elshandi Secara Online">
    <meta name="description" content="Website Undangan Pernikahan Hasna dan Elshandi Secara Online">
    ...
    <meta property="og:title" content="Website Undangan Pernikahan Hasna dan Elshandi Secara Online">
    <meta property="og:description" content="Website Undangan Pernikahan Hasna dan Elshandi Secara Online">
    ...
    <meta property="og:image" content="https://nabilah-shandi-wedding-invitation.netlify.app/assets/images/bg.jpeg">
    <meta property="og:image:secure_url" content="https://nabilah-shandi-wedding-invitation.netlify.app/assets/images/bg.jpeg">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:image:alt" content="Website Undangan Pernikahan Hasna dan Elshandi Secara Online">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="id_ID">
    <meta property="og:url" content="https://nabilah-shandi-wedding-invitation.netlify.app">
    <meta property="og:site_name" content="Website Undangan Pernikahan Hasna dan Elshandi Secara Online">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <!-- Appearance -->
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-title" content="Website Undangan Pernikahan Hasna dan Elshandi Secara Online">
    <meta name="theme-color" content="#111111">
    <meta name="color-scheme" content="dark">
    <link rel="canonical" href="https://nabilah-shandi-wedding-invitation.netlify.app/">
    <link rel="shortcut icon" type="image/x-icon" href="https://nabilah-shandi-wedding-invitation.netlify.app/favicon.ico">
    <link rel="apple-touch-icon" sizes="192x192" type="image/png" href="https://nabilah-shandi-wedding-invitation.netlify.app/assets/images/icon-192x192.png">
    <link rel="icon" type="image/x-icon" href="https://nabilah-shandi-wedding-invitation.netlify.app/favicon.ico">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Merienda:wght@300..900&family=Playwrite+HR+Lijeva:wght@100..400&display=swap" rel="stylesheet">
    ...
    <script src="{{ asset('dist/js/app.js') }}" type="module" defer></script>
</head>

<body data-key="ec8523c51f2d1f75806c7569f721c366175665d9e2f46a9333" data-url="http://localhost:8000" style="overflow-y: hidden;">
    ...
    <!-- Main Content -->
    <main class="bg-brown text-black" data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">

        <!-- Home -->
        <section class="container" id="home">

            <div class="text-center pt-4">
                <h1 class="font-esthetic my-4" style="font-size: 2.3rem;">Undangan Pernikahan</h1>

                <div class="py-4">
                    <div class="img-crop border border-3 border-light shadow mx-auto">
                        <img src="{{ asset('dist/images/bg.jpeg') }}" alt="bg" onclick="util.modal(this)">
                    </div>
                </div>

                <h1 class="font-esthetic my-4" style="font-size: 2.3rem;">Hasna &amp; Elshandi</h1>
                <p class="mb-0" style="font-size: 1.5rem;">Ahad, 15 September 2024</p>

                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2 bg-btn" target="_blank" href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=The%20Wedding%20of%20Hasna%20and%20Elshandi&details=The%20Wedding%20of%20Hasna%20and%20Elshandi%20%7C%2015%20Maret%202023%20%7C%20RT%2010%20RW%2002,%20Desa%20Pajerukan,%20Kec.%20Kalibagor,%20Kab.%20Banyumas,%20Jawa%20Tengah%2053191%20%7C%2010.00%20-%2011.00%20WIB&dates=20230315T100000/20230315T110000&location=https://goo.gl/maps/ALZR6FJZU3kxVwN86">
                    <i class="fa-solid fa-calendar-check me-2 text-black"></i><span class="text-black" style="font-size: 1rem;">Save The Date</span>
                </a>
        ...
        <!-- Mempelai -->
        <section class="dark-section bg-brown mb-2" id="mempelai">
            ...
            <div class="text-center">
                ...
                <h1 class="font-esthetic-2 py-4 px-2" style="font-size: 1.8rem">Assalamualaikum Warahmatullahi Wabarakatuh</h1>

                <p class="pb-3 px-3" style="font-size: 1.2rem;">
                    Kami mengundang Bapak/Ibu/Saudara/i serta kerabat
                ...
                <div class="overflow-x-hidden">
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ asset('dist/images/cewe.png') }}" alt="cewe" onclick="util.modal(this)">
                        </div>
                        <h1 class="font-esthetic-2" style="font-size: 2rem;">R Hasna Nabilah M. S.T</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.5rem;">Putri ketiga dari</p>
                        <p class="mb-0" style="font-size: 1.25rem;">Bapak Achmad Tashlih Hassan <br> &amp; <br> Ibu Diah Sadiah Chaeruddin</p>
                    </div>
                    ...
                    <h1 class="font-esthetic-2 my-4" style="font-size: 4rem;">&</h1>
                    ...
                    <div data-aos="fade-right" data-aos-duration="2000">
                        <div class="img-crop border border-3 border-light shadow my-4 mx-auto">
                            <img src="{{ asset('dist/images/cowo.png') }}" alt="cowo" onclick="util.modal(this)">
                        </div>
                        <h1 class="font-esthetic-2" style="font-size: 2rem;">Elshandi Septiawan S.Kom</h1>
                        <p class="mt-3 mb-0" style="font-size: 1.5rem;">Putra pertama dari</p>
                        <p class="mb-0" style="font-size: 1.25rem;">Bapak Efendi <br> &amp; <br> Ibu Rosneli</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="text-center" data-aos="fade-up" data-aos-duration="2000">
                <p class="pb-3 px-3" style="font-size: 1.2rem;">
                    Tanpa mengurangi rasa hormat, kami berharap agar tamu berkenan untuk ikut serta menyaksikan kebahagiaan kami dengan <span style="font-weight: bold;">tamu Ikhwan (Laki-laki) dan tamu Akhwat (Perempuan) yang terpisah.</span> Mari bersama-sama wujudkan syariat Islam
                </p>
            </div>
        </div>
        ...
        <div class="container">
            <div class="text-center pt-3" data-aos="fade-up" data-aos-duration="2000">
                <h1 class="font-esthetic-2 mt-0 mb-3" style="font-size: 2rem">
        ...
        <!-- Tanggal -->
        <section class="dark-section bg-brown" id="tanggal">

            <div class="container">
                <div class="text-center">

                    <h1 class="font-esthetic-2 py-3" style="font-size: 2rem;">Waktu Menuju Acara</h1>
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">

                        <!-- Ganti waktunya pada data-waktu (sesuai format tersebut) -->
                        <div class="row justify-content-center" data-time="2024-09-15 08:00:00" id="count-down">
                            <div class="col-3 p-1">
                    ...
                    <p style="font-size: 1.2rem;" class="mt-4 py-2">
                    ...
                    <div class="overflow-x-hidden">
                        <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
                            <h1 class="font-esthetic-2" style="font-size: 2rem;">Akad</h1>
                            <p style="font-size: 1.2rem;">Pukul 08.00 WIB - 09.30 WIB</p>
                        </div>

                        <div class="py-2" data-aos="fade-left" data-aos-duration="1500">
                            <h1 class="font-esthetic-2" style="font-size: 2rem;">Resepsi</h1>
                            <p style="font-size: 1.2rem;">Pukul 10.00 WIB - 14.00 WIB</p>
                        </div>
                    </div>

                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <a href="https://www.google.com/maps/place/Jl.+Sukahaji+Permai+No.10A,+RT.002+RW007,+Sukarasa,+Kec.+Sukasari,+Kota+Bandung,+Jawa+Barat+40152/@-6.8693667,107.5813466,17z/data=!3m1!4b1!4m6!3m5!1s0x2e68e6984f899d97:0x431a30eed0dabe81!8m2!3d-6.8693667!4d107.5839215!16s%2Fg%2F11vlz514nb?entry=ttu" target="_blank" class="btn btn-outline-light btn-sm rounded-pill shadow-sm mb-2 px-3 bg-btn">
                            <i class="fa-solid fa-map-location-dot me-2 text-black"></i><span class="text-black" style="font-size: 1.2rem;">Lihat Google Maps</span>
                        </a>
                        <p class="mb-0 mt-1 mx-1 pb-1" style="font-size: 1.2rem;">
                            Jalan Sukahaji Permai No. 10, RT 002 RW 007, Sukarasa, Kec. Sukasari, Kota Bandung, Jawa Barat 40152
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Footer Undangan -->
    <footer class="bg-brown text-black">
        <div class="container">
            <div class="text-center pt-1">

                <p style="font-size: 1.2rem;" class="pt-2 pb-1 px-2" data-aos="fade-up" data-aos-duration="1500">
                    Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila Bapak/Ibu/Saudara/i
                    berkenan hadir untuk memberikan do'a restunya. Kami ucapkan terima kasih.
                </p>

                <h1 class="font-esthetic-2" data-aos="fade-up" data-aos-duration="2000">Wassalamualaikum Warahmatullahi Wabarakatuh</h1>
                <h1 class="font-arabic pt-4 px-2" data-aos="fade-up" data-aos-duration="2000" style="font-size: 2rem;">اَلْحَمْدُ لِلّٰهِ رَبِّ الْعٰلَمِيْنَۙ</h1>
                ...
                <div class="row align-items-center justify-content-center flex-column flex-sm-row">
                    <div class="col-auto">
                        <small>
                            <span>Credit </span><i class="fa-brands fa-github me-1"></i><a target="_blank" href="https://github.com/dewanakl/undangan">dewanakl</a>
                        </small>
                    </div>
                </div>
            </div>
    ...
    <!-- Welcome Page -->
    <div class="loading-page bg-brown text-black" id="welcome" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            <div class="text-center">
                <h1 class="font-esthetic mb-4" style="font-size: 2.3rem;">The Walimatul Ursy Of</h1>

                <div class="img-crop border border-3 border-light shadow mb-4 mx-auto">
                    <img src="{{ asset('dist/images/bg.jpeg') }}" alt="background">
                </div>

                <h1 class="font-esthetic my-4" style="font-size: 2.3rem;">Hasna &amp; Elshandi</h1>
                <div id="guest-name" data-message="Kepada Yth Bapak/Ibu/Saudara/i" class="text-black"></div>
                <div id="form-name" class="text-black"></div>

                <button type="button" class="btn btn-light shadow rounded-4 mt-4 bg-btn" onclick="util.open(this)">
                    <i class="fa-solid fa-envelope-open me-2"></i><span style="font-size: 1.2rem;">Open Invitation</span>
                </button>
            </div>
        </div>
    </div>
    ...
    <!-- Audio Button -->
    <button type="button" id="button-music" style="display: none;" class="btn bg-dark border border-2 btn-sm rounded-circle btn-music" onclick="audio.button(this)" data-status="true" data-url="{{ asset('dist/music/sound.mp3') }}">
    ...
    <div class="loading-page bg-black" id="loading" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
            <div class="w-75 text-center">
                <img class="img-fluid mb-3" src="{{ asset('dist/images/icon-192x192.png') }}" alt="icon" style="width: 3.5rem;">
            ...
            <div class="modal-content rounded-4">
                <div class="modal-body p-0">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
                        <img src="{{ asset('dist/images/bg.jpeg') }}" class="w-100" alt="image" id="show-modal-image">
                    </div>
                </div>
            </div>
        </div>
